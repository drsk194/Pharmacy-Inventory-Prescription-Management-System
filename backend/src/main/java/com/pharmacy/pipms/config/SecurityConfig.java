...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Public — only the endpoints that don't require an existing session
                        .requestMatchers(
                                "/api/auth/register",
                                "/api/auth/login",
                                "/api/auth/refresh",
                        ...
                        // Guest-viewable drug catalog per SRS Section 4 — wired properly in Module 6
                        .requestMatchers("/api/drugs/catalog").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOriginPatterns(List.of("http://localhost:8081", "http://localhost:3000"));
